...
+ (BOOL)isMobileNumber:(NSString *)mobileNum {
    return [mobileNum isMobileNumber];
}
...
- (BOOL)isMobileNumber
{
    ...
    /**
     ...
     22         */
    NSString * CT = @"^1((33|53|8[019]|7[6-8])[0-9]|349)\\d{7}$";
    /**
     25         * 大陆地区固话及小灵通
...
+ (BOOL)isValidatePwd:(NSString *)pwd {
    return [pwd isValidatePassword];
}

-(BOOL)isValidatePassword
{
    NSString *nameRegex = @"[A-Za-z0-9]{6,11}";
