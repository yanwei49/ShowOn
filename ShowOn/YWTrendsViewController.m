...
@interface YWTrendsViewController ()<UITableViewDelegate, UITableViewDataSource, YWFocusTableViewCellDelegate, UISearchBarDelegate>
...
- (void)requestTrendsList {
    NSDictionary *parameters = @{@"userId": _user.userId, @"loginUseruserId": @""};
