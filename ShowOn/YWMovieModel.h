...
@property (nonatomic, strong) NSString    *movieTime;            //视频时间长度
...
@property (nonatomic, strong) NSString    *movieIsSupport;       //当前登录用户是否赞数
@property (nonatomic, strong) NSString    *movieRecorderType;    //视频录制时的类型（0：个人录制   1：合作录制   2：转发）
